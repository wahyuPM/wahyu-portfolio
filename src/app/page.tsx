    ...
    <main className="flex flex-col min-h-[100dvh] space-y-10">
          ...
          <div className="gap-2 flex justify-between">
            <div className="flex-col flex flex-1 space-y-1.5">
              <BlurFadeText
                ...
                yOffset={8}
                text={`Hi, I'm ${data?.user?.name.split(" ")[0]} 👋`}
              />
              <BlurFadeText
            ...
            <BlurFade delay={BLUR_FADE_DELAY}>
              <Avatar className="size-24 lg:size-40 border">
                <AvatarImage
                  alt={data?.user?.name}
      ...
      <section id="education">
        <div className="flex min-h-0 flex-col gap-y-3">
          ...
          {data?.educations?.data?.map((education, id) => (
            <BlurFade
      ...
      <section id="projects">
        <div className="space-y-12 w-full py-12">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 max-w-[800px] mx-auto">
            {data?.projects?.data.map((project, id) => (
              <BlurFade
                key={project.title}
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 13}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Here are some of the certifications I have participated in,
                  showcasing my commitment to continuous learning and
                  innovation.
                </p>
              </div>
            </div>
